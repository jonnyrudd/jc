...
<div class="alert alert-info" role="alert" style="margin:10px 20px 0px 0px;">
	<h2 style="margin:0 auto;"><?php _e('Vendor Maintenance', 'tomo'); ?></h2>
</div>
<div style="padding:10px 20px 0px 0px;">
	...
	<div class="row">
		...
		<div class="col-md-2" style="text-align:right;">
			<a id="btn-add" class="btn btn-success" href="admin.php?page=vendor_request"><i class="fas fa-plus-circle"></i> <?php _e('Add New', 'tomo'); ?></a>
		</div>
	</div>
	
</div>
<?php
		$prodFields = $wpdb->get_results('SHOW FULL COLUMNS FROM vw_active_vendor', ARRAY_N);
		$prodCols = array();
?>
...
jQuery(document).ready(function() {
	...
	jQuery('#btn-reset').on('click', function () {
		location = 'admin.php?page=vendor_info';
	});
