...
( function( $ ) {
	...
	window.GPNestedForms = function( args ) {
		...
		self.init = function() {
			...
			self.fieldContainer      = $( 'li#field_' + self.formId + '_' + self.fieldId );
			...
			$( document ).on( 'click', 'li#field_' + self.formId + '_' + self.fieldId + ' .gpnf-add-entry', function( event ) {
